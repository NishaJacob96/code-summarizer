...
def build_or_load_gen_model(args):
    ...
    if args.model_type == 'roberta':
        ...
        decoder_layer = DecoderLayer(d_model=config.hidden_size, ffn_hidden=2048, n_head=config.num_attention_heads, drop_prob=0.1)
        decoder = Decoder(config.vocab_size, 512, d_model=config.hidden_size, ffn_hidden=2048, n_head=config.num_attention_heads, n_layers=6, drop_prob=0.2, device='cuda')
